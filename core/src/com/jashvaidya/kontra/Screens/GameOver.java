...
/**
 * Gameover screen occurs when the player dies and gives the option to play again
 *
 * @author Jash Vaidya
 * @version 1.0
 */
...
public class GameOver implements Screen {
    ...
    /**
     * render method runs every frame of the game, so it is used to check if the player starts a new game once any key is pressed during the game over screen
     *
